$(function () {
    ...
    $("#processing").on('click', function(e){
        ...
        function bookingTemplate(booking) {
                   ...
                   ' <tr>'+
                    ...
                    '<td>'+booking.book_status+'</td>'+
                    '<td>'+booking.payment+'</td>'+
                    '<td>'+booking.mechanic.firstName+'<br/><button type="button" id="update-password" booking_id="'+booking._id+'" class="btn complete">Mark Complete</button></td>'+
                '</tr>';
                    return bookingRow;
                }
                ...
                $.ajax({
                    type: 'GET',
                    url: base_url + 'bookings/book?book=processing',
                    success: function (bookings) {
                        let bookingRows = [];
                        $.each(bookings, function (index, booking) {
                            bookingRows.push(bookingTemplate(booking));
    ...
    bookingBody.on('click', '.complete', function () {
